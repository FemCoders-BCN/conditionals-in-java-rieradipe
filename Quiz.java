...
public class Quiz {
    public static void main(String[] args) {
        ...
        // Si el puntaje es menor de 15 pero mayor o igual a 5, imprime: No lo has hecho
        // mal
        // De lo contrario imprime: Buena suerte la próxima vez
        // Las opciones a, b, c y d de cada pregunta, deberán dejar en terminal un
        // espacio de sangría, averigua como hacerlo en java
        ...
        if (respuesta3.toLowerCase().contains("b")) {
            puntaje += 5;
        }
        if (respuesta3.toLowerCase().contains("d")) {
            puntaje += 5;
        }
        // 4 pregunta
        ...
        System.out.println("\n Tú puntuaje total es de : " + puntaje + "/25");
        if (puntaje >= 15) {
            System.out.println("Tú si que sabes mucho!");
        } else if (puntaje >= 5) {
            System.out.println("No lo has hecho mal");
        } else {
            System.out.println("Buena suerte lpa próxima vez");
        }
        scanner.close();
    }
}
